...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notifId = if (type.equals(TYPE_ONE_TIME, ignoreCase = true)) ID_ONETIME else ID_REPEAT
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String){
        ...
        val pendingIntent = PendingIntent.getBroadcast(context, ID_REPEAT, intent, PendingIntent.FLAG_IMMUTABLE)
    ...
    companion object{
        ...
        //id untuk 2 alarm, onetime dan repeating
