        ...
        client.enqueue(object : Callback<PostReviewResponse>{
            override fun onResponse(
                ...
                if (response.isSuccessful && responseBody != null) {
                    responseBody.customerReviews?.let { reviews ->
                        setReviewData(reviews.filterNotNull())
                    }
                } else {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (responseBody != null) {
                        responseBody.restaurant?.let { restaurant ->
                            setRestaurantData(restaurant)

                            // Ambil list, pastikan tidak null, dan filter item yang null
                            restaurant.customerReviews?.let { reviews ->
                                setReviewData(reviews.filterNotNull())
                            }
                        }
                    }
